...
<a
  ...
  href="https://playground.ethid.org/?path=/docs/molecules-follower-tag--component-docs"
  target="_blank"
>
  <span className="text-primary">Try it out!</span>
  <span className="text-gray-400">
    {' - https://playground.ethid.org/?path=/docs/molecules-follower-tag--component-docs'}
  </span>
</a>
