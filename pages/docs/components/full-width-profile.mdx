...
|                       | - `onEditProfileClick`: Function that runs when clicking the edit profile button.                   |          |               |
|                       | - `hideSocials`: Array of social media platforms to hide.                                           |          |               |
|                       | - `hideEFPPoaps`: Boolean to hide EFP POAPs.                                                        |          |               |
|                       | - `customPoaps`: Array of custom POAPs to display. See `ProfileEFPPoapResponse` type for details.   |          |               |
|                       | - `onBioLinkClick`: Function to handle link clicks in the bio.                                      |          |               |
