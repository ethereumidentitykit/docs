...
<Callout type="warning">
  When using the `options` prop, ensure that all required data is provided if you're using prefetched data. Missing data
  may cause the component to fail to render properly.
</Callout>
