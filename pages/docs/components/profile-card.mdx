...
<a
  ...
  href="https://playground.ethid.org/?path=/docs/organisms-profile-card--component-docs"
  target="_blank"
>
  <span className="text-primary">Try it out!</span>
  <span className="text-gray-400">
    {' - https://playground.ethid.org/?path=/docs/organisms-profile-card--component-docs'}
  </span>
</a>

<div className="w-full bg-[#222] border-[3px] rounded-md border-[#444] p-8 mt-6 flex justify-center items-center">
