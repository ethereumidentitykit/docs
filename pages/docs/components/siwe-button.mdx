...
| `onDisconnected`  | Callback function called when the user disconnects their wallet.                                    | No       | -             |
...
| `onSignedInClick` | Callback function called when the user clicks the signed in button.                                 | No       | -             |
| `isSignedIn`      | Boolean indicating if the user is signed in.                                                        | No       | false         |
| `isDropdown`      | Boolean indicating if the button is a dropdown button.                                              | No       | false         |
| `isDropdownOpen`  | Boolean indicating if the dropdown is open.                                                         | No       | false         |
