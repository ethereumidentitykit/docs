...
<a
  ...
  href="https://playground.ethidentitykit.com/?path=/story/organisms-full-width-profile-card--full-width-profile-card-by-address"
  target="_blank"
>
  <span className="text-primary">Try it out!</span>
  <span className="text-gray-400">
    {
      ' - https://playground.ethidentitykit.com/?path=/story/organisms-full-width-profile-card--full-width-profile-card-by-address'
    }
  </span>
</a>
