...
<a
  ...
  href="https://playground.ethidentitykit.com/?path=/docs/organisms-user-profile--component-docs"
  target="_blank"
>
  <span className="text-primary">Try it out!</span>
  <span className="text-gray-400">
    {' - https://playground.ethidentitykit.com/?path=/docs/organisms-user-profile--component-docs'}
  </span>
</a>
