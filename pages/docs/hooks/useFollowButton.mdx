...
| `forceState`       | State of the follow button to be displayed over the normal follow state.  | No       | -             |
| `initialState`     | Initial state of the follow button.                                       | No       | -             |
| `showBlockBack`    | Whether to show the block back button.                                    | No       | false         |
| `showMuteBack`     | Whether to show the mute back button.                                     | No       | false         |
