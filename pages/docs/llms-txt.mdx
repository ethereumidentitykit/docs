...
- [https://ethidentitykit.com/llms.txt](https://ethidentitykit.com/llms.txt) Minimal EIK context for internet connected agents
- [https://ethidentitykit.com/llms-full.txt](https://ethidentitykit.com/llms-full.txt) Full EIK context for local agents
