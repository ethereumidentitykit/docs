...
In accordance with the [llms.txt](https://llmstxt.org/) standard, EIK provides two LLM context files:

- [https://ethidentitykit.com/llms.txt](https://ethidentitykit.com/llms.txt) Minimal EIK context for remote agents [<a href="https://ethidentitykit.com/llms.txt" download="llms.txt">Download</a>]
- [https://ethidentitykit.com/llms-full.txt](https://ethidentitykit.com/llms-full.txt) Full EIK context for local agents [<a href="https://ethidentitykit.com/llms-full.txt" download="llms-full.txt">Download</a>]
